...
> 审查日期：2026-07-16 · 基线分支 `master` / `release`  
...
| C3 | fixed | 文档标题与产品文案已去掉迭代版本号；包/OpenAPI 版本见 `pyproject.toml` / `main.py` | `pyproject.toml` / `main.py` / README |

## 高

| ID | 状态 | 问题 | 位置 |
|----|------|------|------|
| H1 | open | CI 仅触发 `main`/`master`，日常功能分支推送不一定跑 | `.github/workflows/ci.yml` |
