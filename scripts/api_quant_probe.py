...
BATCH2: list[MutDef] = [
    ...
    MutDef(
        ...
        ["nodes", "edges"],
        skip=True,
        skip_reason="GET /graph view removed; edge CRUD remains",
    ),
    MutDef(
        "B2-12",
        "POST",
    ...
    MutDef(
        ...
        ["files"],
        skip=True,
        skip_reason="theory workspace HTTP removed",
    ),
    MutDef(
        "B2-17",
        "PUT",
    ...
    MutDef(
        ...
        ["nodes", "edges"],
        skip=True,
        skip_reason="assumption-dag HTTP removed",
    ),
    MutDef(
        "B2-20",
        "GET",
        "/v1/theory/assumption-dag/impact/A4",
        "T1",
        {200},
        skip=True,
        skip_reason="assumption-dag HTTP removed",
